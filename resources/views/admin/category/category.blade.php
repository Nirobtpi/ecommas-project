                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img style="width: 60px; height:60px"
                                    src="{{ asset('uploads/category') }}/{{ $category->category_image }}" alt="" class="rounded-circle">
                                @endif
                            </td>
                            <td>
                                <a  href="{{ route('category.edit',$category->id) }}" class="btn btn-sm btn-info">Edit</a>
                                <a onclick="confirm('Are You Sure?')" href="{{ route('category.delete',$category->id) }}" class="btn btn-sm btn-danger">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
                ...
                <div class="card-body">
                    ...
                    <form class="row g-3" action="{{ route('category.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                            ...
                            <div class="mt-3">
                                <img src="" width="60px" height="60px" alt="" id="nirob">
                            </div>
                            @error('photo')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
