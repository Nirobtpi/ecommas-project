...
<!-- Mirrored from assiagroupe.vercel.app/oredoo/Oredoo/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Nov 2024 04:02:04 GMT -->
<!-- Added by HTTrack -->
    ...
    <header class="header navbar-expand-lg fixed-top ">
        <div class="container-fluid ">
            <div class="header-area ">
                ...
                <div class="logo">
                    <a href="index.html">
                        <img src="{{ asset('frontend_assets') }}/img/logo/logo-dark.png" alt=""
                            class="logo-dark">
                        <img src="{{ asset('frontend_assets') }}/img/logo/logo-white.png" alt=""
                            class="logo-white">
                    </a>
                </div>
                        ...
                        <div class="collapse navbar-collapse" id="main_nav">
                            <ul class="navbar-nav ">
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle active" href="index.html" data-toggle="dropdown">
                                        Home </a>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link  dropdown-toggle " href="#" data-toggle="dropdown"> Blogs
                                    </a>
                                    <ul class="dropdown-menu fade-up">
                                        <li>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" target="_blank"
                                        href="{{ route('author.dashboard') }}">Admin Panel</a>
            ...
            <div class="row">
                <div class="col-lg-7 col-md-10 m-auto">
                    <div class="search-width">
                        ...
                        <form class="search-form" action="https://assiagroupe.vercel.app/oredoo/Oredoo/search.html">
...
<!-- Mirrored from assiagroupe.vercel.app/oredoo/Oredoo/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Nov 2024 04:02:37 GMT -->
