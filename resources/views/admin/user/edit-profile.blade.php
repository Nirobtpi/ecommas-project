                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="POST" action="{{ route('admin.update.profile',Auth::user()->id) }}">
                            ...
                            <div class="col-12">
                                ...
                                <input type="email" name="email" readonly value="{{ Auth::user()->email }}" class="form-control" id="email" readonly>
                            </div>
            ...
            <div class="col-lg-6">
                <div class="card text-start">
                    ...
                    @endif
                        ...
                        <form class="row g-3" method="POST" action="{{ route('admin.update.password',Auth::user()->id) }}">
                            @csrf
                            <div class="col-12">
